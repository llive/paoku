		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<?php  if($_W['plugin']!='merch'&&empty($_W['merchid'])) { ?>
					...
					<?php  if(p('creditshop')) { ?>
					<a class="btn btn-xs <?php  if($_GPC['type']==6) { ?>btn-primary<?php  } else { ?>btn-default<?php  } ?>" href="<?php  echo webUrl('diypage/temp', array('type'=>6, 'cate'=>$_GPC['cate'], 'keyword'=>$_GPC['keyword']))?>">卡路里商城</a>
					<?php  } ?>
					<?php  if(p('seckill')) { ?>
